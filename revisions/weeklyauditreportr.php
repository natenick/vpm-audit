<?php
    ...
    include_once './audit/layout/header.php';
        ...
        <div class="container"> -->
            <div class="">
                ...
                <div class="side-navbar active-nav bg-dark" id="sidebar">
                    <form action="functions/request.php" method="POST" id="weekly-form">
                        <input type="hidden" name="action" value="create-weekly-report">
...
<script>
    ...
    weeklyForm.addEventListener('submit', async (e) => {
        ...
        await axios
            .post(`functions/request.php`, formData)
            .then(response => {
    ...
    const fetchWeeklyReport = async () => {
        ...
        await axios
            .get(`functions/request.php?action=get-weekly-report-api`)
            .then( response => {
